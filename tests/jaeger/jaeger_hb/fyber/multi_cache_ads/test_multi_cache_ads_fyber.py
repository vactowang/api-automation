...
class TestMultiCacheAdsFyber(object):
    ...
    def test_fyber_winttl_sdk_version_1(self, pub_app_id, placement, sdk_v):
        info = request_hb_win_notification('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(1)
        if info['is_hbp_responded_200']:
            req = info['hbp_request']
            r = post_hbp_request(hbp_fyber_endpoint_qa, json=req, headers=hbp_headers())
    ...
    def test_fyber_winttl_sdk_version_2(self, pub_app_id, placement, sdk_v):
        info = request_hb_win_notification('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(1)
        if info['is_hbp_responded_200']:
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_fyber_adm_1(self, pub_app_id, placement, sdk_v):
        info = request_hbp('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
            assert_valid_schema(response_payload, response_schema.hbp_fyber)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0'])
    def test_fyber_adm_2(self, pub_app_id, placement, sdk_v):
        info = request_hbp('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
    ...
    def test_fyber_adm_impression_url(self, pub_app_id, placement, sdk_v):
        info = request_hbp('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
    ...
    def test_fyber_winttl_filter_out_1(self, pub_app_id, placement, sdk_v):
        info = request_hbp('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_fyber_winttl_filter_out_2(self, pub_app_id, placement, sdk_v):
        info = request_hb_loss_notification('fyber', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                            test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(0.1)
        if info['is_hbp_responded_200']:
            req = info['hbp_request']
