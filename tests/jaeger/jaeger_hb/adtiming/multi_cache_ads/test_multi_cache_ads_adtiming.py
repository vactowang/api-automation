...
class TestMultiCacheAdsAdtiming(object):
    ...
    def test_adtiming_winttl_sdk_version_1(self, pub_app_id, placement, sdk_v):
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(0.1)
        if info['is_hbp_responded_200']:
            req = info['hbp_request']
            r = post_hbp_request(hbp_adtiming_endpoint_qa, json=req, headers=hbp_headers(debug='jaeger'))
    ...
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_sdk_version_1_1(self, pub_app_id, placement, sdk_v):
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(0.1)
        if info['is_hbp_responded_200']:
            req = info['hbp_request']
            r = post_hbp_request_no_retry(hbp_adtiming_endpoint_qa, json=req, headers=hbp_headers(debug='jaeger'))
    ...
    def test_adtiming_winttl_sdk_version_2(self, pub_app_id, placement, sdk_v):
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(0.1)
        if info['is_hbp_responded_200']:
    ...
    @pytest.mark.parametrize('placement', [common_test_placement_1])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0'])
    def test_adtiming_winttl_sdk_version_2_1(self, pub_app_id, placement, sdk_v):
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(0.1)
        if info['is_hbp_responded_200']:
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_adm_1(self, pub_app_id, placement, sdk_v):
        info = request_hbp('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
            assert_valid_schema(response_payload, response_schema.hbp_adtiming)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0'])
    def test_adtiming_adm_2(self, pub_app_id, placement, sdk_v):
        info = request_hbp('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
    ...
    def test_adtiming_adm_impression_url(self, pub_app_id, placement, sdk_v):
        info = request_hbp('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
    ...
    def test_adtiming_winttl_filter_out_1(self, pub_app_id, placement, sdk_v):
        info = request_hbp('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement, test_device_id=gen_device_id(),
                           sdk_v=sdk_v)
        if info['is_hbp_responded_200']:
            response_payload = info['hbp_response']
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_filter_out_2(self, pub_app_id, placement, sdk_v):
        info = request_hb_loss_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                            test_device_id=gen_device_id(), sdk_v=sdk_v)
        time.sleep(0.1)
        if info['is_hbp_responded_200']:
            req = info['hbp_request']
            r = post_hbp_request(hbp_adtiming_endpoint_qa, json=req, headers=hbp_headers())
    ...
    @pytest.mark.parametrize('placement', [common_test_placement_1])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_ordinal_view_check_1(self, pub_app_id, placement, sdk_v):
        ...
        if info['is_hbp_responded_200']:
            ...
            req = request_payload.hbp_partner('adtiming', pub_app_id=pub_app_id, placement_id=placement, ifa=test_ifa,
                                              bid_token=super_token)
            r = post_hbp_request_no_retry(hbp_adtiming_endpoint_qa, json=req,
    ...
    @pytest.mark.parametrize('placement', [common_test_placement_1])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_ordinal_view_check_2(self, pub_app_id, placement, sdk_v):
        test_ifa = gen_device_id()
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=test_ifa, sdk_v=sdk_v)
        time.sleep(0.1)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement_1])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_ordinal_view_check_3(self, pub_app_id, placement, sdk_v):
        test_ifa = gen_device_id()
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=test_ifa, sdk_v=sdk_v)
        time.sleep(0.1)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_ordinal_view_check_4(self, pub_app_id, placement, sdk_v):
        test_ifa = gen_device_id()
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=test_ifa, sdk_v=sdk_v)
        time.sleep(0.1)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_ordinal_view_check_5(self, pub_app_id, placement, sdk_v):
        test_ifa = gen_device_id()
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=test_ifa, sdk_v=sdk_v)
        time.sleep(0.1)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_ordinal_view_check_6(self, pub_app_id, placement, sdk_v):
        test_ifa = gen_device_id()
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=test_ifa, sdk_v=sdk_v)
        time.sleep(0.1)
    ...
    @pytest.mark.parametrize('placement', [common_test_placement_1])
    @pytest.mark.parametrize('sdk_v', ['Vungle/6.10.0', 'Vungle/6.10.1', 'Vungle/6.10.2'])
    def test_adtiming_winttl_twice_hit_delete_winttl_precache(self, pub_app_id, placement, sdk_v):
        test_ifa = gen_device_id()
        info = request_hb_win_notification('adtiming', 11, pub_app_id=pub_app_id, placement_ref_id=placement,
                                           test_device_id=test_ifa, sdk_v=sdk_v)
        time.sleep(0.1)
