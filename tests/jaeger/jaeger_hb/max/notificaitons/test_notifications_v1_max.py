...
@allure.epic('HBP Max')
class TestNotificationsV1Max(object):
    ...
    @allure.description('Verify that the default ordinal view count in nurl for Max')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_default_ordinal_view_ount_in_nurl_max(self, pub_app_id):
    ...
    @allure.tag('smoke')
    @allure.story('PBJ-1904 HBP Max support')
    @allure.description('Verify that the default ordinal view count in burl for Max')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_default_ordinal_view_ount_in_burl_max(self, pub_app_id):
        test_ifa = gen_device_id()
        req = request_payload.hbp_max(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_max_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke')
    @allure.story('PBJ-1904 HBP Max support')
    @allure.description('Verify that the default ordinal view count in lurl for Max')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_default_ordinal_view_ount_in_lurl_max(self, pub_app_id):
        test_ifa = gen_device_id()
        req = request_payload.hbp_max(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_max_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
