...
class TestNotificationsV2Ohayoo(object):
    ...
    @allure.feature('ohayoo support')
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the NURL contains action mbr for Ohayoo')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_nurl_details_ohayoo(self, pub_app_id):
        ...
        if r.status_code == HTTPStatus.OK:
            ...
            assert_that(ext['name'], equal_to('ohayoo'))
    ...
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the LURL contains action mbr for Ohayoo')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_lurl_details_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the LURL contains settlement price for Ohayoo')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_lurl_contains_settlement_price_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description(
        'Verify that the Ohayoo NURL contains ordinal view count, the value is half of the original ordinal view count')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_nurl_ordinal_view_count_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the Ohayoo LURL does not contains action mbr')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_auction_mbr_not_in_lurl_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the Ohayoo LURL does not contain network clearing price')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_network_clearing_price_not_in_lurl_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the Ohayoo LURL contains ordinal view count')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_ordinal_view_ount_in_lurl_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo')
    @allure.description('Verify that the Ohayoo NURL does not contain isBill')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_is_bill_not_in_nurl_ohayoo(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_ohayoo_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
