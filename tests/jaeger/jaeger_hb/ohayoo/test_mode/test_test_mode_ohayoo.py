...
@allure.epic('HBP Ohayoo')
class TestTestModeOhayoo(object):

    @allure.feature('test mode')
    @allure.tag('normal', 'R_v0.34.0', 'R_v0.31.0')
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo'
                  'PBJ-2190 Generic testing endpoint for Vungle app bidding')
    @allure.description('Verify the Ohayoo test mode with the token not in redis for v1 token')
    @allure.severity('normal')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_1(self, pub_app_id, endpoint):
        test_ifa = gen_device_id()
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa,
    ...
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo'
                  'PBJ-2190 Generic testing endpoint for Vungle app bidding')
    @allure.description('Verify the Ohayoo non test mode with the token not in redis for v1 token')
    @allure.severity('normal')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_2(self, pub_app_id, endpoint):
        test_ifa = gen_device_id()
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa,
    ...
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo'
                  'PBJ-2190 Generic testing endpoint for Vungle app bidding')
    @allure.description('Verify the Ohayoo test mode with the token not in redis for v2 token')
    @allure.severity('normal')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_3(self, pub_app_id, endpoint):
        test_ifa = gen_device_id()
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa,
                                         bid_token=s2s_test_mode_token, is_test=1)
        r = post_hbp_request(endpoint, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.story('PBJ-2140 New Bidding Endpoint for Ohayoo'
                  'PBJ-2190 Generic testing endpoint for Vungle app bidding')
    @allure.description('Verify the Ohayoo non test mode with the token not in redis for v2 token')
    @allure.severity('normal')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_4(self, pub_app_id, endpoint):
        test_ifa = gen_device_id()
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_ifa,
                                         bid_token=s2s_test_mode_token, is_test=0)
        r = post_hbp_request(endpoint, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_enhance_1(self, pub_app_id, endpoint):
    ...
    @allure.severity('normal')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa])
    def test_ohayoo_test_mode_enhance_2(self, pub_app_id, endpoint):
        jaeger_response_t = request_ads_ios(test_ifa=test_mode_device_id, rtb=test_mode_kraken_rtb_ids)
        bid_token_t = jaeger_response_t['ads'][0]['ad_markup']['bid_token']
        bid_tokens_with_ordinal_view_count_t = bid_token_t + ':' + str(7)
        super_token = "2:" + base64.b64encode(bid_tokens_with_ordinal_view_count_t.encode('ascii')).decode('ascii')
    ...
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_enhance_3(self, pub_app_id, endpoint):
    ...
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_enhance_4(self, pub_app_id, endpoint):
        jaeger_response = request_ads_ios(test_ifa=gen_device_id())
        bid_token = jaeger_response['ads'][0]['ad_markup']['bid_token']
        bid_tokens_with_ordinal_view_count = bid_token + ':' + str(7)
        super_token = "2:" + base64.b64encode(bid_tokens_with_ordinal_view_count.encode('ascii')).decode('ascii')
    ...
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_flag_1(self, pub_app_id, endpoint):
        ...
        req = request_payload.hbp_ohayoo(pub_app_id, common_test_placement, ifa=test_mode_device_id,
    ...
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    @pytest.mark.parametrize('endpoint', [hbp_ohayoo_endpoint_qa, hbp_test_endpoint_qa])
    def test_ohayoo_test_mode_flag_2(self, pub_app_id, endpoint):
        jaeger_response = request_ads_ios(test_ifa=gen_device_id())
        ordinal_view_count = 7
        bid_token = jaeger_response['ads'][0]['ad_markup']['bid_token']
        bid_tokens_with_ordinal_view_count = bid_token + ':' + str(ordinal_view_count)
