...
class TestNotificationsV2Facebook(object):
    ...
    @allure.description('Verify that the NURL contains action mbr for fb_test')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_nurl_details_fb_test(self, pub_app_id):
        ...
        if r.status_code == HTTPStatus.OK:
            ...
            assert_that(bid_info['nurl'].count('winner_type'), equal_to(1))
            assert_that(bid_info['nurl'].count('winner_name'), equal_to(1))
            assert_that(bid_info['nurl'].count('phase'), equal_to(1))
            assert_that(bid_info['nurl'].count('ext='), equal_to(1))
            ext = decode_ext(url=bid_info['nurl'])
            assert_that(ext['name'], equal_to('fb_test'))
    ...
    @allure.tag('smoke', 'v0.50.0')
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description('Verify that the LURL contains action mbr for fb_test')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_lurl_details_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
        ...
        if r.status_code == HTTPStatus.OK:
            ...
            assert_that(bid_info['lurl'].count('winner_type'), equal_to(1))
            assert_that(bid_info['lurl'].count('winner_name'), equal_to(1))
            assert_that(bid_info['lurl'].count('phase'), equal_to(1))
    ...
    @allure.tag('smoke', 'v0.50.0')
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description('Verify that the LURL contains settlement price for fb_test')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_lurl_contains_settlement_price_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description(
        'Verify that fb_test NURL contains ordinal view count, the value is half of the original ordinal view count')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_nurl_ordinal_view_count_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'v0.50.0')
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description('Verify that the fb_test LURL does not contains action mbr')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_auction_mbr_not_in_lurl_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'v0.50.0')
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description('Verify that the fb_test LURL does not contain network clearing price')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_network_clearing_price_not_in_lurl_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'v0.50.0')
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description('Verify that the fb_test LURL contains ordinal view count')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_ordinal_view_ount_in_lurl_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    @allure.tag('smoke', 'v0.50.0')
    @allure.story('PBJ-2839 Support Facebook Bidding Kit Server Integration')
    @allure.description('Verify that the fb_test NURL does not contain isBill')
    @allure.severity('smoke')
    @pytest.mark.parametrize('pub_app_id', [common_test_app])
    def test_is_bill_not_in_nurl_fb_test(self, pub_app_id):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, common_test_placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
    ...
    def test_url_use_https_fb_test(self, pub_app_id, placement):
        test_ifa = gen_device_id(36)
        req = request_payload.hbp_common(pub_app_id, placement, ifa=test_ifa, bid_token=super_token)
        r = post_hbp_request(hbp_fb_test_endpoint_qa, json=req, headers=hbp_headers(openrtb='2.5'))
