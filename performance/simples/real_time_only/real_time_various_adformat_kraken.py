...
class various_adformat_non_precached_kraken(TaskSet):
    ...
    tasks = {vungle_mraid.hb_video_kraken: 1, vungle_mraid.hb_banner_kraken: 1,
             vungle_mraid.hb_video_mrec_kraken: 1}
...
class various_adformat_precached_kraken(TaskSet):
    ...
    tasks = {vungle_mraid.hb_banner_kraken_precached: 1,
             vungle_mraid.hb_video_mrec_kraken_precached: 1,
             vungle_mraid.hb_video_kraken_precached:1}
